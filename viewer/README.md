...
output. The existing Viewer shell carries workflow progress; the Project Story Timeline with
Phases and Milestones; Chapter Story and Insights; Privacy choices; Preferences; All set; Release
Preview; and HTML/ZIP handoff.
...
The localhost Viewer, its working artifacts, and the final package flow do not automatically upload
or publish data, and there is no online deployment path. `publication_approved=false` remains
unchanged.
