...
if (!destination || process.argv.length !== 3) throw new Error("Usage: node tests/fixtures/seed-chapter-privacy.mjs <new-state-directory>");
...
try {
  ...
  const { run } = await seedChapterPrivacy(db, { interactive: true, badSecondChapter: false });
