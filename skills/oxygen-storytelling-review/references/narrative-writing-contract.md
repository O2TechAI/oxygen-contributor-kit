# Evidence-driven narrative writing contract

Use this contract when generating or revising Project Story, Chapter Story, passage assistance, or the single canonical Chapter Insight. It governs selection and writing; it never authorizes access beyond the reviewed evidence boundary.
...
A Phase names a supported class of project problem or transition. Internally, be able to answer:

> What kind of problem did the Chapters in this Phase resolve or clarify?
...
```text
tension / disagreement / failed direction
+ decisive reframing, boundary, or result
```
...
- which decision, fork, or constraint was open;
- what would change depending on the answer;
- why the question mattered at that moment.
...
```text
initial claim
→ objection or failed observation
→ reframe
→ decision
...
- the project or privacy boundary;
...
> What became possible, impossible, or newly testable after this moment?

Do not promote a passing comment into a turn without evidence.

## Result

State the resulting decision, capability, failure, constraint, or next test. Preserve the difference between a hypothesis, an interim choice, a validated outcome, and a final boundary. Do not rewrite an incomplete decision as success.
...
- which evidence justified the conclusion;
- which tension remained unresolved.
...
→ what should be asked or tested first?
...
Uncertainty is durable project memory, not a flaw to edit away.

## Product mapping

```text
Phase
= class of problem or transition
...
For every Chapter, verify with safe structured data:
